...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "O2'/Hh",
            BaseRibose(RESIDUES[1], RESIDUES[0], None),
        ),
        (
            (RESIDUES[0], RESIDUES[1]),
            "Hh/O2'",
            BaseRibose(RESIDUES[0], RESIDUES[1], None),
        ),
        (
            (RESIDUES[6], RESIDUES[12]),
            "O2'/SS",
            BaseRibose(RESIDUES[12], RESIDUES[6], None),
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            (RESIDUES[0], RESIDUES[1]),
            "O2P/Hh",
            BasePhosphate(RESIDUES[1], RESIDUES[0], None),
        ),
        (
            (RESIDUES[0], RESIDUES[1]),
            "Hh/O2P",
            BasePhosphate(RESIDUES[0], RESIDUES[1], None),
        ),
        (
            (RESIDUES[6], RESIDUES[12]),
            "O2P/SS",
            BasePhosphate(RESIDUES[12], RESIDUES[6], None),
        ),
    ],
)
